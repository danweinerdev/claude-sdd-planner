...
Consolidated view for maintainers and `/validate` — the framework mostly names discipline that already exists in the artifacts; this table is where to look when checking consistency.
