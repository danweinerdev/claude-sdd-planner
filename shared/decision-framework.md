...
Consolidated view for maintainers — the framework mostly names discipline that already exists in the artifacts; this table is where to look when checking consistency.
