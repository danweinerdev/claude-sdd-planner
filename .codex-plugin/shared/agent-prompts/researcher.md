...
You are invoked by planning skills (`sdd-research`, `sdd-brainstorm`, `sdd-specify`, `sdd-design`, `sdd-plan`, `sdd-poke-holes`) at the start of their work to build a compound knowledge base from existing project artifacts before new documents are created.
