...
func handlerFlagSets() []struct {
	...
	return []struct {
		...
		{"sdd graph sync", []string{"plan", "node", "by", "report", "report-exit", "red-kind", "fault", "command-exit", "command-log", "json", "verbose"}},
		{"sdd graph reverify", []string{"plan", "report", "command-exit", "command-log", "json", "verbose"}},
