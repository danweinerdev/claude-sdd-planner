...
func handlerFlagSets() []struct {
	...
	return []struct {
		...
		{"sdd graph reverify", []string{"plan", "report", "command-exit", "command-log", "json"}},
		...
		{"sdd graph amend", []string{"plan", "node", "from-review", "expect-digest", "by", "dry-run", "json"}},
		...
		{"sdd graph set-artifacts", []string{"plan", "node", "by", "file", "json"}},
